...
| npm | `@babel/generator` | `7.29.8` | MIT | PASS |
| npm | `@babel/helper-compilation-targets` | `7.29.7` | MIT | PASS |
| npm | `@babel/helper-globals` | `7.29.7` | MIT | PASS |
| npm | `@babel/helper-module-imports` | `7.29.7` | MIT | PASS |
| npm | `@babel/helper-module-transforms` | `7.29.7` | MIT | PASS |
| npm | `@babel/helper-string-parser` | `7.29.7` | MIT | PASS |
| npm | `@babel/helper-validator-identifier` | `7.29.7` | MIT | PASS |
| npm | `@babel/helper-validator-option` | `7.29.7` | MIT | PASS |
| npm | `@babel/helpers` | `7.29.7` | MIT | PASS |
| npm | `@babel/parser` | `7.29.8` | MIT | PASS |
| npm | `@babel/template` | `7.29.7` | MIT | PASS |
| npm | `@babel/traverse` | `7.29.8` | MIT | PASS |
| npm | `@babel/types` | `7.29.8` | MIT | PASS |
| npm | `@eslint-community/eslint-utils` | `4.10.1` | MIT | PASS |
| npm | `@eslint-community/regexpp` | `4.12.2` | MIT | PASS |
| npm | `@eslint/config-array` | `0.23.5` | Apache-2.0 | PASS |
| npm | `@eslint/config-helpers` | `0.7.0` | Apache-2.0 | PASS |
| npm | `@eslint/core` | `1.2.1` | Apache-2.0 | PASS |
| npm | `@eslint/js` | `10.0.1` | MIT | PASS |
| npm | `@eslint/object-schema` | `3.0.5` | Apache-2.0 | PASS |
| npm | `@eslint/plugin-kit` | `0.7.2` | Apache-2.0 | PASS |
| npm | `@humanfs/core` | `0.19.2` | Apache-2.0 | PASS |
| npm | `@humanfs/node` | `0.16.8` | Apache-2.0 | PASS |
| npm | `@humanfs/types` | `0.15.0` | Apache-2.0 | PASS |
| npm | `@humanwhocodes/module-importer` | `1.0.1` | Apache-2.0 | PASS |
| npm | `@humanwhocodes/retry` | `0.4.3` | Apache-2.0 | PASS |
| npm | `@jridgewell/gen-mapping` | `0.3.13` | MIT | PASS |
| npm | `@jridgewell/remapping` | `2.3.5` | MIT | PASS |
| npm | `@jridgewell/resolve-uri` | `3.1.2` | MIT | PASS |
| npm | `@jridgewell/sourcemap-codec` | `1.5.5` | MIT | PASS |
| npm | `@jridgewell/trace-mapping` | `0.3.31` | MIT | PASS |
| npm | `@oxc-project/types` | `0.146.0` | MIT | PASS |
| npm | `@rolldown/binding-android-arm-eabi` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-android-arm64` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-darwin-arm64` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-darwin-x64` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-freebsd-x64` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-linux-arm-gnueabihf` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-linux-arm64-gnu` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-linux-arm64-musl` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-linux-ppc64-gnu` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-linux-s390x-gnu` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-linux-x64-gnu` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-linux-x64-musl` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-openharmony-arm64` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-win32-arm64-msvc` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/binding-win32-x64-msvc` | `1.2.5` | MIT | PASS |
| npm | `@rolldown/pluginutils` | `1.0.1` | MIT | PASS |
| npm | `@standard-schema/spec` | `1.1.0` | MIT | PASS |
| npm | `@types/chai` | `5.2.3` | MIT | PASS |
| npm | `@types/deep-eql` | `4.0.2` | MIT | PASS |
| npm | `@types/esrecurse` | `4.3.1` | MIT | PASS |
| npm | `@types/estree` | `1.0.9` | MIT | PASS |
| npm | `@types/json-schema` | `7.0.15` | MIT | PASS |
| npm | `@types/react` | `19.2.18` | MIT | PASS |
| npm | `@types/react-dom` | `19.2.4` | MIT | PASS |
| npm | `@typescript-eslint/eslint-plugin` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/parser` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/project-service` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/scope-manager` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/tsconfig-utils` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/type-utils` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/types` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/typescript-estree` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/utils` | `8.67.0` | MIT | PASS |
| npm | `@typescript-eslint/visitor-keys` | `8.67.0` | MIT | PASS |
| npm | `@vitejs/plugin-react` | `6.1.0` | MIT | PASS |
| npm | `@vitest/expect` | `4.1.11` | MIT | PASS |
| npm | `@vitest/mocker` | `4.1.11` | MIT | PASS |
| npm | `@vitest/pretty-format` | `4.1.11` | MIT | PASS |
| npm | `@vitest/runner` | `4.1.11` | MIT | PASS |
| npm | `@vitest/snapshot` | `4.1.11` | MIT | PASS |
| npm | `@vitest/spy` | `4.1.11` | MIT | PASS |
| npm | `@vitest/utils` | `4.1.11` | MIT | PASS |
| npm | `acorn` | `8.18.0` | MIT | PASS |
| npm | `acorn-jsx` | `5.3.2` | MIT | PASS |
| npm | `ajv` | `6.15.0` | MIT | PASS |
| npm | `assertion-error` | `2.0.1` | MIT | PASS |
| npm | `balanced-match` | `4.0.4` | MIT | PASS |
| npm | `baseline-browser-mapping` | `2.11.18` | Apache-2.0 | PASS |
| npm | `brace-expansion` | `5.0.9` | MIT | PASS |
| npm | `browserslist` | `4.28.8` | MIT | PASS |
| npm | `caniuse-lite` | `1.0.30001809` | CC-BY-4.0 | PASS |
| npm | `chai` | `6.2.2` | MIT | PASS |
| npm | `convert-source-map` | `2.0.0` | MIT | PASS |
| npm | `cross-spawn` | `7.0.6` | MIT | PASS |
| npm | `csstype` | `3.2.3` | MIT | PASS |
| npm | `debug` | `4.4.3` | MIT | PASS |
| npm | `deep-is` | `0.1.4` | MIT | PASS |
| npm | `detect-libc` | `2.1.2` | Apache-2.0 | PASS |
| npm | `electron-to-chromium` | `1.5.412` | ISC | PASS |
| npm | `es-module-lexer` | `2.3.2` | MIT | PASS |
| npm | `escalade` | `3.2.0` | MIT | PASS |
| npm | `escape-string-regexp` | `4.0.0` | MIT | PASS |
| npm | `eslint` | `10.9.0` | MIT | PASS |
| npm | `eslint-plugin-react-hooks` | `7.1.1` | MIT | PASS |
| npm | `eslint-plugin-react-refresh` | `0.5.4` | MIT | PASS |
| npm | `eslint-scope` | `9.1.2` | BSD-2-Clause | PASS |
| npm | `eslint-visitor-keys` | `3.4.3` | Apache-2.0 | PASS |
| npm | `eslint-visitor-keys` | `5.0.1` | Apache-2.0 | PASS |
| npm | `espree` | `11.2.0` | BSD-2-Clause | PASS |
| npm | `esquery` | `1.7.0` | BSD-3-Clause | PASS |
| npm | `esrecurse` | `4.3.0` | BSD-2-Clause | PASS |
| npm | `estraverse` | `5.3.0` | BSD-2-Clause | PASS |
| npm | `estree-walker` | `3.0.3` | MIT | PASS |
| npm | `esutils` | `2.0.3` | BSD-2-Clause | PASS |
| npm | `expect-type` | `1.4.0` | Apache-2.0 | PASS |
| npm | `fast-deep-equal` | `3.1.3` | MIT | PASS |
| npm | `fast-json-stable-stringify` | `2.1.0` | MIT | PASS |
| npm | `fast-levenshtein` | `2.0.6` | MIT | PASS |
| npm | `fdir` | `6.5.0` | MIT | PASS |
| npm | `file-entry-cache` | `8.0.0` | MIT | PASS |
| npm | `find-up` | `5.0.0` | MIT | PASS |
| npm | `flat-cache` | `4.0.1` | MIT | PASS |
| npm | `flatted` | `3.4.4` | ISC | PASS |
| npm | `fsevents` | `2.3.3` | MIT | PASS |
| npm | `gensync` | `1.0.0-beta.2` | MIT | PASS |
| npm | `glob-parent` | `6.0.2` | ISC | PASS |
| npm | `hermes-estree` | `0.25.1` | MIT | PASS |
| npm | `hermes-parser` | `0.25.1` | MIT | PASS |
| npm | `ignore` | `5.3.2` | MIT | PASS |
| npm | `ignore` | `7.0.6` | MIT | PASS |
| npm | `imurmurhash` | `0.1.4` | MIT | PASS |
| npm | `is-extglob` | `2.1.1` | MIT | PASS |
| npm | `is-glob` | `4.0.3` | MIT | PASS |
| npm | `isexe` | `2.0.0` | ISC | PASS |
| npm | `js-tokens` | `4.0.0` | MIT | PASS |
| npm | `jsesc` | `3.1.0` | MIT | PASS |
| npm | `json-buffer` | `3.0.1` | MIT | PASS |
| npm | `json-schema-traverse` | `0.4.1` | MIT | PASS |
| npm | `json-stable-stringify-without-jsonify` | `1.0.1` | MIT | PASS |
| npm | `json5` | `2.2.3` | MIT | PASS |
| npm | `keyv` | `4.5.4` | MIT | PASS |
| npm | `levn` | `0.4.1` | MIT | PASS |
| npm | `lightningcss` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-android-arm64` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-darwin-arm64` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-darwin-x64` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-freebsd-x64` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-linux-arm-gnueabihf` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-linux-arm64-gnu` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-linux-arm64-musl` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-linux-x64-gnu` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-linux-x64-musl` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-win32-arm64-msvc` | `1.33.0` | MPL-2.0 | PASS |
| npm | `lightningcss-win32-x64-msvc` | `1.33.0` | MPL-2.0 | PASS |
| npm | `locate-path` | `6.0.0` | MIT | PASS |
| npm | `lru-cache` | `5.1.1` | ISC | PASS |
| npm | `lucide-react` | `1.33.0` | ISC | PASS |
| npm | `magic-string` | `0.30.21` | MIT | PASS |
| npm | `minimatch` | `10.2.6` | BlueOak-1.0.0 | PASS |
| npm | `ms` | `2.1.3` | MIT | PASS |
| npm | `nanoid` | `3.3.18` | MIT | PASS |
| npm | `natural-compare` | `1.4.0` | MIT | PASS |
| npm | `node-releases` | `2.0.53` | MIT | PASS |
| npm | `obug` | `2.1.4` | MIT | PASS |
| npm | `optionator` | `0.9.4` | MIT | PASS |
| npm | `p-limit` | `3.1.0` | MIT | PASS |
| npm | `p-locate` | `5.0.0` | MIT | PASS |
| npm | `path-exists` | `4.0.0` | MIT | PASS |
| npm | `path-key` | `3.1.1` | MIT | PASS |
| npm | `pathe` | `2.0.3` | MIT | PASS |
| npm | `picocolors` | `1.1.1` | ISC | PASS |
| npm | `picomatch` | `4.0.5` | MIT | PASS |
| npm | `postcss` | `8.5.26` | MIT | PASS |
| npm | `prelude-ls` | `1.2.1` | MIT | PASS |
| npm | `punycode` | `2.3.1` | MIT | PASS |
| npm | `react` | `19.2.8` | MIT | PASS |
| npm | `react-dom` | `19.2.8` | MIT | PASS |
| npm | `rolldown` | `1.2.5` | MIT | PASS |
| npm | `scheduler` | `0.27.0` | MIT | PASS |
| npm | `semver` | `6.3.1` | ISC | PASS |
| npm | `semver` | `7.8.5` | ISC | PASS |
| npm | `shebang-command` | `2.0.0` | MIT | PASS |
| npm | `shebang-regex` | `3.0.0` | MIT | PASS |
| npm | `siginfo` | `2.0.0` | ISC | PASS |
| npm | `source-map-js` | `1.2.1` | BSD-3-Clause | PASS |
| npm | `stackback` | `0.0.2` | MIT | PASS |
| npm | `std-env` | `4.2.0` | MIT | PASS |
| npm | `tinybench` | `2.9.0` | MIT | PASS |
| npm | `tinyexec` | `1.3.0` | MIT | PASS |
| npm | `tinyglobby` | `0.2.17` | MIT | PASS |
| npm | `tinyrainbow` | `3.1.1` | MIT | PASS |
| npm | `ts-api-utils` | `2.5.0` | MIT | PASS |
| npm | `type-check` | `0.4.0` | MIT | PASS |
| npm | `typescript` | `5.9.3` | Apache-2.0 | PASS |
| npm | `typescript-eslint` | `8.67.0` | MIT | PASS |
| npm | `update-browserslist-db` | `1.3.1` | MIT | PASS |
| npm | `uri-js` | `4.4.1` | BSD-2-Clause | PASS |
| npm | `vite` | `8.2.2` | MIT | PASS |
| npm | `vitest` | `4.1.11` | MIT | PASS |
| npm | `which` | `2.0.2` | ISC | PASS |
| npm | `why-is-node-running` | `2.3.0` | MIT | PASS |
| npm | `word-wrap` | `1.2.5` | MIT | PASS |
| npm | `yallist` | `3.1.1` | ISC | PASS |
